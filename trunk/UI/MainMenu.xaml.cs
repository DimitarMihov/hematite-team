...
namespace UI
{
    ...
    /// </summary>
    public sealed partial class MainMenu : UI.Common.LayoutAwarePage
    {
        public MainMenu()
        {
        ...
        private void DistributorsMenuButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(DistributorsPage));
        }

        private void EmployeesMenuButton_Click(object sender, RoutedEventArgs e)
        {
